...
- `export_guide_outline_data.py`: each generated guide content JSON should include non-empty `blocks[]`; spot-check representative pages such as `frontend/src/generated/guideContent/中級-guide1/mid-s1c1.json` for depth 2–8 blocks and verify headings/questions are not conflated.
