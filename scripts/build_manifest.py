...
GUIDES_BY_LEVEL: dict[str, dict[int, dict]] = {
    ...
    '中級': {
        ...
        3: {
            'id': 'mid-s3',
            'key': 'guide3',
            'pdf': 'AI應用規劃師(中級)-學習指引-科目3機器學習技術與應用_20251222101907.pdf',
            'subject': '中級科目三：機器學習技術與應用',
            'chapters': [
                {
                    'id': 'mid-s3c1', 'title': '機率/統計之機器學習基礎應用', 'start_page': '3-2',
                    'subtopics': ['機率統計基礎', '統計推論', '機器學習資料分佈', '模型評估基礎'],
                },
                {
                    'id': 'mid-s3c2', 'title': '線性代數之機器學習基礎應用', 'start_page': '3-9',
                    'subtopics': ['向量與矩陣', '矩陣運算', '特徵值與特徵向量', '降維基礎'],
                },
                {
                    'id': 'mid-s3c3', 'title': '數值優化技術與方法', 'start_page': '3-18',
                    'subtopics': ['最佳化問題', '梯度下降', '學習率', '損失函數'],
                },
                {
                    'id': 'mid-s3c4', 'title': '機器學習原理與技術', 'start_page': '4-2',
                    'subtopics': ['監督式學習', '非監督式學習', '強化學習', '模型泛化'],
                },
                {
                    'id': 'mid-s3c5', 'title': '常見機器學習演算法', 'start_page': '4-12',
                    'subtopics': ['迴歸與分類', '決策樹與集成模型', 'SVM與KNN', '分群與降維'],
                },
                {
                    'id': 'mid-s3c6', 'title': '深度學習原理與框架', 'start_page': '4-54',
                    'subtopics': ['神經網路', 'CNN/RNN/Transformer', '深度學習框架', '訓練與推論'],
                },
                {
                    'id': 'mid-s3c7', 'title': '數據準備與特徵工程', 'start_page': '5-2',
                    'subtopics': ['資料清理', '特徵選擇', '特徵轉換', '資料切分'],
                },
                {
                    'id': 'mid-s3c8', 'title': '模型選擇與架構設計', 'start_page': '5-11',
                    'subtopics': ['模型選型', '架構設計', '資料規模與限制', '基準模型'],
                },
                {
                    'id': 'mid-s3c9', 'title': '模型訓練、評估與驗證', 'start_page': '5-17',
                    'subtopics': ['訓練流程', '交叉驗證', '評估指標', '錯誤分析'],
                },
                {
                    'id': 'mid-s3c10', 'title': '模型調整與優化', 'start_page': '5-30',
                    'subtopics': ['超參數調校', '正則化', '早停', '模型優化'],
                },
                {
                    'id': 'mid-s3c11', 'title': '數據隱私、安全與合規', 'start_page': '6-2',
                    'subtopics': ['資料隱私', '資訊安全', '法規合規', '模型治理'],
                },
                {
                    'id': 'mid-s3c12', 'title': '演算法偏見與公平性', 'start_page': '6-14',
                    'subtopics': ['偏見來源', '公平性指標', '偏見緩解', '透明性與可解釋性'],
                },
            ],
        },
    },
